...
*/
(function(ia){'use strict';function Rf(a){if(fa(a))R(a.objectMaxDepth)&&(de.objectMaxDepth=fd(a.objectMaxDepth)?a.objectMaxDepth:NaN);else return de}function fd(a){return Pa(a)&&0<a}function va(a){return function(){var b=arguments[0];var d="["+(a?a+":":"")+b+"] http://errors.angularjs.org/1.6.4-local+sha.617b36117/"+(a?a+"/":"")+b;for(b=1;b<arguments.length;b++){d=d+(1==b?"?":"&")+"p"+(b-1)+"=";var c=encodeURIComponent;var e=arguments[b];e="function"==typeof e?e.toString().replace(/ \{[\s\S]*$/,""):"undefined"==
typeof e?"undefined":"string"!=typeof e?JSON.stringify(e):e;d+=c(e)}return Error(d)}}function ub(a){if(null==a||ac(a))return!1;if(oa(a)||na(a)||da&&a instanceof da)return!0;var b="length"in Object(a)&&a.length;return Pa(b)&&(0<=b&&(b-1 in a||a instanceof Array)||"function"===typeof a.item)}function I(a,b,d){var c;if(a)if(ca(a))for(g in a)"prototype"!==g&&"length"!==g&&"name"!==g&&a.hasOwnProperty(g)&&b.call(d,a[g],g,a);else if(oa(a)||ub(a)){var e="object"!==typeof a;var g=0;for(c=a.length;g<c;g++)(e||
g in a)&&b.call(d,a[g],g,a)}else if(a.forEach&&a.forEach!==I)a.forEach(b,d,a);else if(ee(a))for(g in a)b.call(d,a[g],g,a);else if("function"===typeof a.hasOwnProperty)for(g in a)a.hasOwnProperty(g)&&b.call(d,a[g],g,a);else for(g in a)bb.call(a,g)&&b.call(d,a[g],g,a);return a}function fe(a,b,d){for(var c=Object.keys(a).sort(),e=0;e<c.length;e++)b.call(d,a[c[e]],c[e]);return c}function gd(a){return function(b,d){a(d,b)}}function Sf(){return++sc}function hd(a,b,d){for(var c=a.$$hashKey,e=0,g=b.length;e<
g;++e){var f=b[e];if(fa(f)||ca(f))for(var k=Object.keys(f),h=0,l=k.length;h<l;h++){var m=k[h],q=f[m];d&&fa(q)?Xa(q)?a[m]=new Date(q.valueOf()):tc(q)?a[m]=new RegExp(q):q.nodeName?a[m]=q.cloneNode(!0):id(q)?a[m]=q.clone():"__proto__"!==m&&(fa(a[m])||(a[m]=oa(q)?[]:{}),hd(a[m],[q],!0)):a[m]=q}}c?a.$$hashKey=c:delete a.$$hashKey;return a}function Aa(a){return hd(a,hb.call(arguments,1),!1)}function Tf(a){return hd(a,hb.call(arguments,1),!0)}function jd(a,b){return Aa(Object.create(a),b)}function ja(){}
...
case "[object Exception]":return!0;case "[object DOMException]":return!0;default:return a instanceof Error}}function ca(a){return"function"===typeof a}function tc(a){return"[object RegExp]"===Ta.call(a)}function ac(a){return a&&a.window===a}function bc(a){return a&&a.$evalAsync&&a.$watch}function vb(a){return"boolean"===typeof a}function Uf(a){return a&&Pa(a.length)&&Vf.test(Ta.call(a))}function id(a){return!(!a||!(a.nodeName||a.prop&&a.attr&&a.find))}function Wf(a){var b={};a=a.split(",");var d;
for(d=0;d<a.length;d++)b[a[d]]=!0;return b}function ib(a){return xa(a.nodeName||a[0]&&a[0].nodeName)}function cc(a,b){b=a.indexOf(b);0<=b&&a.splice(b,1);return b}function Bb(a,b,d){function c(h,l,m){m--;if(0>m)return"...";var q=l.$$hashKey;if(oa(h)){var t=0;for(var w=h.length;t<w;t++)l.push(e(h[t],m))}else if(ee(h))for(t in h)l[t]=e(h[t],m);else if(h&&"function"===typeof h.hasOwnProperty)for(t in h)h.hasOwnProperty(t)&&(l[t]=e(h[t],m));else for(t in h)bb.call(h,t)&&(l[t]=e(h[t],m));q?l.$$hashKey=
q:delete l.$$hashKey;return l}function e(h,l){if(!fa(h))return h;var m=f.indexOf(h);if(-1!==m)return k[m];if(ac(h)||bc(h))throw Cb("cpws");m=!1;var q=g(h);void 0===q&&(q=oa(h)?[]:Object.create(ge(h)),m=!0);f.push(h);k.push(q);return m?c(h,q,l):q}function g(h){switch(Ta.call(h)){case "[object Int8Array]":case "[object Int16Array]":case "[object Int32Array]":case "[object Float32Array]":case "[object Float64Array]":case "[object Uint8Array]":case "[object Uint8ClampedArray]":case "[object Uint16Array]":case "[object Uint32Array]":return new h.constructor(e(h.buffer),
...
case "number":a=""+a;break;default:a=!kd(a)||oa(a)||Xa(a)?ec(a):a.toString()}return a}function dg(a){function b(e,g,f){return e[g]||(e[g]=f())}var d=va("$injector"),c=va("ng");a=b(a,"angular",Object);a.$$minErr=a.$$minErr||va;return b(a,"module",function(){var e={};return function(g,f,k){var h={};if("hasOwnProperty"===g)throw c("badname","module");f&&e.hasOwnProperty(g)&&(e[g]=null);return b(e,g,function(){function l(C,D,y,v){v||(v=q);return function(){v[y||"push"]([C,D,arguments]);return F}}function m(C,
D,y){y||(y=q);return function(v,p){p&&ca(p)&&(p.$$moduleName=g);y.push([C,D,arguments]);return F}}if(!f)throw d("nomod",g);var q=[],t=[],w=[],H=l("$injector","invoke","push",t),F={_invokeQueue:q,_configBlocks:t,_runBlocks:w,info:function(C){if(R(C)){if(!fa(C))throw c("aobj","value");h=C;return this}return h},requires:f,name:g,provider:m("$provide","provider"),factory:m("$provide","factory"),service:m("$provide","service"),value:l("$provide","value"),constant:l("$provide","constant","unshift"),decorator:m("$provide",
"decorator",t),animation:m("$animateProvider","register"),filter:m("$filterProvider","register"),controller:m("$controllerProvider","register"),directive:m("$compileProvider","directive"),component:m("$compileProvider","component"),config:H,run:function(C){w.push(C);return this}};k&&H(k);return F})}})}function kb(a,b){if(oa(a)){b=b||[];for(var d=0,c=a.length;d<c;d++)b[d]=a[d]}else if(fa(a))for(d in b=b||{},a)if("$"!==d.charAt(0)||"$"!==d.charAt(1))b[d]=a[d];return b||a}function eg(a,b){var d=[];fd(b)&&
...
var g=(e=b[e||c.type])?e.length:0;if(g){if(U(c.immediatePropagationStopped)){var f=c.stopImmediatePropagation;c.stopImmediatePropagation=function(){c.immediatePropagationStopped=!0;c.stopPropagation&&c.stopPropagation();f&&f.call(c)}}c.isImmediatePropagationStopped=function(){return!0===c.immediatePropagationStopped};var k=e.specialHandlerWrapper||lg;1<g&&(e=kb(e));for(var h=0;h<g;h++)c.isImmediatePropagationStopped()||k(a,c,e[h])}};d.elem=a;return d}function lg(a,b,d){d.call(a,b)}function mg(a,b,
d){var c=b.relatedTarget;c&&(c===a||og.call(a,c))||d.call(a,b)}function pg(){this.$get=function(){return Aa(Ha,{hasClass:function(a,b){a.attr&&(a=a[0]);return Bc(a,b)},addClass:function(a,b){a.attr&&(a=a[0]);return Dc(a,b)},removeClass:function(a,b){a.attr&&(a=a[0]);return Cc(a,b)}})}}function Pb(a,b){var d=a&&a.$$hashKey;if(d)return"function"===typeof d&&(d=a.$$hashKey()),d;d=typeof a;return d="function"===d||"object"===d&&null!==a?a.$$hashKey=d+":"+(b||Sf)():d+":"+a}function ve(){this._keys=[];
this._values=[];this._lastKey=NaN;this._lastIndex=-1}function we(a){a=Function.prototype.toString.call(a).replace(qg,"");return a.match(rg)||a.match(sg)}function tg(a){return(a=we(a))?"function("+(a[1]||"").replace(/[\s\r\n]+/," ")+")":"fn"}function gc(a,b){function d(C){return function(D,y){if(fa(D))I(D,gd(C));else return C(D,y)}}function c(C,D){Ob(C,"service");if(ca(D)||oa(D))D=t.instantiate(D);if(!D.$get)throw Eb("pget",C);return q[C+"Provider"]=D}function e(C,D){return function(){var y=F.invoke(D,
this);if(U(y))throw Eb("undef",C);return y}}function g(C,D,y){return c(C,{$get:!1!==y?e(C,D):D})}function f(C){hc(U(C)||oa(C),"modulesToLoad","not an array");var D=[],y;I(C,function(v){function p(r){var n;var x=0;for(n=r.length;x<n;x++){var G=r[x],B=t.get(G[0]);B[G[1]].apply(B,G[2])}}if(!m.get(v)){m.set(v,!0);try{na(v)?(y=zd(v),F.modules[v]=y,D=D.concat(f(y.requires)).concat(y._runBlocks),p(y._invokeQueue),p(y._configBlocks)):ca(v)?D.push(t.invoke(v)):oa(v)?D.push(t.invoke(v)):vc(v,"module")}catch(r){throw oa(v)&&
(v=v[v.length-1]),r.message&&r.stack&&-1===r.stack.indexOf(r.message)&&(r=r.message+"\n"+r.stack),Eb("modulerr",v,r.stack||r.message||r);}}});return D}function k(C,D){function y(p,r){if(C.hasOwnProperty(p)){if(C[p]===h)throw Eb("cdep",p+" <- "+l.join(" <- "));return C[p]}try{return l.unshift(p),C[p]=h,C[p]=D(p,r),C[p]}catch(n){throw C[p]===h&&delete C[p],n;}finally{l.shift()}}function v(p,r,n){var x=[];p=gc.$$annotate(p,b,n);for(var G=0,B=p.length;G<B;G++){var A=p[G];if("string"!==typeof A)throw Eb("itkn",
A);x.push(r&&r.hasOwnProperty(A)?r[A]:y(A,n))}return x}return{invoke:function(p,r,n,x){"string"===typeof n&&(x=n,n=null);n=v(p,n,x);oa(p)&&(p=p[p.length-1]);x=p;if(qb||"function"!==typeof x)x=!1;else{var G=x.$$ngIsClass;vb(G)||(G=x.$$ngIsClass=/^(?:class\b|constructor\()/.test(Function.prototype.toString.call(x)));x=G}return x?(n.unshift(null),new (Function.prototype.bind.apply(p,n))):p.apply(r,n)},instantiate:function(p,r,n){var x=oa(p)?p[p.length-1]:p;p=v(p,r,n);p.unshift(null);return new (Function.prototype.bind.apply(x,
p))},get:y,annotate:gc.$$annotate,has:function(p){return q.hasOwnProperty(p+"Provider")||C.hasOwnProperty(p)}}}b=!0===b;var h={},l=[],m=new Hc,q={$provide:{provider:d(c),factory:d(g),service:d(function(C,D){return g(C,["$injector",function(y){return y.instantiate(D)}])}),value:d(function(C,D){return g(C,cb(D),!1)}),constant:d(function(C,D){Ob(C,"constant");q[C]=D;w[C]=D}),decorator:function(C,D){var y=t.get(C+"Provider"),v=y.$get;y.$get=function(){var p=F.invoke(v,y);return F.invoke(D,null,{$delegate:p})}}}},
...
function g(){p=null;k()}function f(){C=r();C=U(C)?null:C;db(C,G)&&(C=G);D=G=C}function k(){var B=D;f();if(y!==h.url()||B!==C)y=h.url(),D=C,I(n,function(A){A(h.url(),C)})}var h=this,l=a.location,m=a.history,q=a.setTimeout,t=a.clearTimeout,w={};h.isMock=!1;var H=0,F=[];h.$$completeOutstandingRequest=e;h.$$incOutstandingRequestCount=function(){H++};h.notifyWhenNoOutstandingRequests=function(B){0===H?B():F.push(B)};var C,D,y=l.href,v=b.find("base"),p=null,r=c.history?function(){try{return m.state}catch(B){}}:
ja;f();h.url=function(B,A,E){U(E)&&(E=null);l!==a.location&&(l=a.location);m!==a.history&&(m=a.history);if(B){var L=D===E;if(y===B&&(!c.history||L))return h;var Q=y&&Gb(y)===Gb(B);y=B;D=E;!c.history||Q&&L?(Q||(p=B),A?l.replace(B):Q?(A=l,E=B.indexOf("#"),E=-1===E?"":B.substr(E),A.hash=E):l.href=B,l.href!==B&&(p=B)):(m[A?"replaceState":"pushState"](E,"",B),f());p&&(p=B);return h}return p||l.href.replace(/%27/g,"'")};h.state=function(){return C};var n=[],x=!1,G=null;h.onUrlChange=function(B){if(!x){if(c.history)da(a).on("popstate",
g);da(a).on("hashchange",g);x=!0}n.push(B);return B};h.$$applicationDestroyed=function(){da(a).off("hashchange popstate",g)};h.$$checkUrlChange=k;h.baseHref=function(){var B=v.attr("href");return B?B.replace(/^(https?:)?\/\/[^/]*/,""):""};h.defer=function(B,A){H++;var E=q(function(){delete w[E];e(B)},A||0);w[E]=!0;return E};h.defer.cancel=function(B){return w[B]?(delete w[B],t(B),e(ja),!0):!1}}function xg(){this.$get=["$window","$log","$sniffer","$document",function(a,b,d,c){return new wg(a,c,b,d)}]}
function yg(){this.$get=function(){function a(d,c){function e(w){w!==q&&(t?t===w&&(t=w.n):t=w,g(w.n,w.p),g(w,q),q=w,q.n=null)}function g(w,H){w!==H&&(w&&(w.p=H),H&&(H.n=w))}if(d in b)throw va("$cacheFactory")("iid",d);var f=0,k=Aa({},c,{id:d}),h=Ea(),l=c&&c.capacity||Number.MAX_VALUE,m=Ea(),q=null,t=null;return b[d]={put:function(w,H){if(!U(H)){if(l<Number.MAX_VALUE){var F=m[w]||(m[w]={key:w});e(F)}w in h||f++;h[w]=H;f>l&&this.remove(t.key);return H}},get:function(w){if(l<Number.MAX_VALUE){var H=
m[w];if(!H)return;e(H)}return h[w]},remove:function(w){if(l<Number.MAX_VALUE){var H=m[w];if(!H)return;H===q&&(q=H.p);H===t&&(t=H.n);g(H.n,H.p);delete m[w]}w in h&&(delete h[w],f--)},removeAll:function(){h=Ea();f=0;m=Ea();q=t=null},destroy:function(){m=k=h=null;delete b[d]},info:function(){return Aa({},k,{size:f})}}}var b={};a.info=function(){var d={};I(b,function(c,e){d[e]=c.info()});return d};a.get=function(d){return b[d]};return a}}function zg(){this.$get=["$cacheFactory",function(a){return a("templates")}]}
function xe(a,b){function d(y,v,p){var r=/^([@&<]|=(\*?))(\??)\s*([\w$]*)$/,n=Ea();I(y,function(x,G){x=x.trim();if(x in q)n[G]=q[x];else{var B=x.match(r);if(!B)throw Ka("iscp",v,G,x,p?"controller bindings definition":"isolate scope definition");n[G]={mode:B[1][0],collection:"*"===B[2],optional:"?"===B[3],attrName:B[4]||G};B[4]&&(q[x]=n[G])}});return n}function c(y){var v=y.charAt(0);if(!v||v!==xa(v))throw Ka("baddir",y);if(y!==y.trim())throw Ka("baddir",y);}function e(y){var v=y.require||y.controller&&
y.name;!oa(v)&&fa(v)&&I(v,function(p,r){var n=p.match(l);p.substring(n[0].length)||(v[r]=n[0]+r)});return v}var g={},f=/^\s*directive:\s*([\w-]+)\s+(.*)$/,k=/(([\w-]+)(?::([^;]+))?;?)/,h=Wf("ngSrc,ngSrcset,src,srcset"),l=/^(?:(\^\^?)?(\?)?(\^\^?)?)?/,m=/^(on[a-z]+|formaction)$/,q=Ea();this.directive=function r(v,p){hc(v,"name");Ob(v,"directive");na(v)?(c(v),hc(p,"directiveFactory"),g.hasOwnProperty(v)||(g[v]=[],a.factory(v+"Directive",["$injector","$exceptionHandler",function(n,x){var G=[];I(g[v],
function(B,A){try{var E=n.invoke(B);ca(E)?E={compile:cb(E)}:!E.compile&&E.link&&(E.compile=cb(E.link));E.priority=E.priority||0;E.index=A;E.name=E.name||v;E.require=e(E);A=E;var L=E.restrict;if(L&&(!na(L)||!/[EACM]/.test(L)))throw Ka("badrestrict",L,v);A.restrict=L||"EA";E.$$moduleName=B.$$moduleName;G.push(E)}catch(Q){x(Q)}});return G}])),g[v].push(p)):I(v,gd(r));return this};this.component=function n(p,r){function x(B){function A(Q){return ca(Q)||oa(Q)?function(S,X){return B.invoke(Q,this,{$element:S,
$attrs:X})}:Q}var E=r.template||r.templateUrl?r.template:"",L={controller:G,controllerAs:Ag(r.controller)||r.controllerAs||"$ctrl",template:A(E),templateUrl:A(r.templateUrl),transclude:r.transclude,scope:{},bindToController:r.bindings||{},restrict:"E",require:r.require};I(r,function(Q,S){"$"===S.charAt(0)&&(L[S]=Q)});return L}if(!na(p))return I(p,gd(Mb(this,n))),this;var G=r.controller||function(){};I(r,function(B,A){"$"===A.charAt(0)&&(x[A]=B,ca(G)&&(G[A]=B))});x.$inject=["$injector"];return this.directive(p,
...
function(p){return arguments.length?(F=p,this):F};var C=!0;this.commentDirectivesEnabled=function(p){return arguments.length?(C=p,this):C};var D=!0;this.cssClassDirectivesEnabled=function(p){return arguments.length?(D=p,this):D};this.$get=["$injector","$interpolate","$exceptionHandler","$templateRequest","$parse","$controller","$rootScope","$sce","$animate","$$sanitizeUri",function(p,r,n,x,G,B,A,E,L,Q){function S(){try{if(!--ye)throw Hb=void 0,Ka("infchng",F);A.$apply(function(){for(var u=0,z=Hb.length;u<
z;++u)try{Hb[u]()}catch(J){n(J)}Hb=void 0})}finally{ye++}}function X(u,z){if(z){var J=Object.keys(z),M;var N=0;for(M=J.length;N<M;N++){var K=J[N];this[K]=z[K]}}else this.$attr={};this.$$element=u}function ha(u,z,J){ze.innerHTML="<span "+z+">";z=ze.firstChild.attributes;var M=z[0];z.removeNamedItem(M.name);M.value=J;u.attributes.setNamedItem(M)}function ka(u,z){try{u.addClass(z)}catch(J){}}function ea(u,z,J,M,N){u instanceof da||(u=da(u));var K=ma(u,z,u,J,M,N);ea.$$addScopeClass(u);var aa=null;return function(O,
...
N+=" "+Ca(K[V+1])}K=Ca(K[2*Z]).split(/\s/);N+=Q(Ca(K[0]),!0);2===K.length&&(N+=" "+Ca(K[1]));this[u]=z=N}!1!==J&&(null==z?this.$$element.removeAttr(M):Og.test(M)?this.$$element.attr(M,z):ha(this.$$element[0],M,z));(u=this.$$observers)&&I(u[aa],function(W){try{W(z)}catch(ba){n(ba)}})},$observe:function(u,z){var J=this,M=J.$$observers||(J.$$observers=Ea()),N=M[u]||(M[u]=[]);N.push(z);A.$evalAsync(function(){N.$$inter||!J.hasOwnProperty(u)||U(J[u])||z(J[u])});return function(){cc(N,z)}}};var Ne=r.startSymbol(),
...
f);g.$scope[f]=k}return function(g,f,k,h){var l;k=!0===k;h&&na(h)&&(l=h);if(na(g)){h=g.match(Pe);if(!h)throw Qe("ctrlfmt",g);var m=h[1];l=l||h[3];g=a.hasOwnProperty(m)?a[m]:ne(f.$scope,m,!0)||(b?ne(c,m,!0):void 0);if(!g)throw Qe("ctrlreg",m);vc(g,m,!0)}if(k){k=(oa(g)?g[g.length-1]:g).prototype;var q=Object.create(k||null);l&&e(f,l,q,m||g.name);return Aa(function(){var t=d.invoke(g,q,f,m);t!==q&&(fa(t)||ca(t))&&(q=t,l&&e(f,l,q,m||g.name));return q},{instance:q,identifier:l})}q=d.instantiate(g,f,m);
l&&e(f,l,q,m||g.name);return q}}]}function Sg(){this.$get=["$window",function(a){return da(a.document)}]}function Tg(){this.$get=["$document","$rootScope",function(a,b){function d(){e=c.hidden}var c=a[0],e=c&&c.hidden;a.on("visibilitychange",d);b.$on("$destroy",function(){a.off("visibilitychange",d)});return function(){return e}}]}function Ug(){this.$get=["$log",function(a){return function(b,d){a.error.apply(a,arguments)}}]}function Kd(a){return fa(a)?Xa(a)?a.toISOString():ec(a):a}function Vg(){this.$get=
...
Te(E),void 0,A.transformRequest);U(L)&&I(E,function(Q,S){"content-type"===xa(S)&&delete E[S]});U(A.withCredentials)&&!U(a.withCredentials)&&(A.withCredentials=a.withCredentials);return w(A,L).then(n,n)});v=p(v,B);return v=v.finally(function(){e.$$completeOutstandingRequest(ja)})}function w(v,p){function r(ka){if(ka){var ea={};I(ka,function(ma,la){ea[la]=function(ya){function ua(){ma(ya)}b?h.$applyAsync(ua):h.$$phase?ua():h.$apply(ua)}});return ea}}function n(ka,ea,ma,la,ya){function ua(){x(ea,ka,
...
a.xsrfHeaderName]=ha),g(v.method,X,p,n,Q,v.timeout,v.withCredentials,v.responseType,r(v.eventHandlers),r(v.uploadEventHandlers)));return E}function H(v,p){0<p.length&&(v+=(-1===v.indexOf("?")?"?":"&")+p);return v}function F(v,p){var r=v.split("?");if(2<r.length)throw Sc("badjsonp",v);r=pd(r[1]);I(r,function(n,x){if("JSON_CALLBACK"===n)throw Sc("badjsonp",v);if(x===p)throw Sc("badjsonp",p,v);});return v+=(-1===v.indexOf("?")?"?":"&")+p+"=JSON_CALLBACK"}var C=k("$http");a.paramSerializer=na(a.paramSerializer)?
m.get(a.paramSerializer):a.paramSerializer;var D=[];I(d,function(v){D.unshift(na(v)?m.get(v):m.invoke(v))});var y=ah(c);t.pendingRequests=[];(function(v){I(arguments,function(p){t[p]=function(r,n){return t(Aa({},n||{},{method:p,url:r}))}})})("get","delete","head","jsonp");(function(v){I(arguments,function(p){t[p]=function(r,n,x){return t(Aa({},x||{},{method:p,url:r,data:n}))}})})("post","put","patch");t.defaults=a;return t}]}function bh(){this.$get=function(){return function(){return new ia.XMLHttpRequest}}}
function ch(){this.$get=["$browser","$jsonpCallbacks","$document","$xhrFactory",function(a,b,d,c){return dh(a,c,a.defer,b,d[0])}]}function dh(a,b,d,c,e){function g(f,k,h){f=f.replace("JSON_CALLBACK",k);var l=e.createElement("script"),m=null;l.type="text/javascript";l.src=f;l.async=!0;m=function(q){l.removeEventListener("load",m);l.removeEventListener("error",m);e.body.removeChild(l);l=null;var t=-1,w="unknown";q&&("load"!==q.type||c.wasCalled(k)||(q={type:"error"}),w=q.type,t="error"===q.type?404:
200);h&&h(t,w)};l.addEventListener("load",m);l.addEventListener("error",m);e.body.appendChild(l);return m}return function(f,k,h,l,m,q,t,w,H,F){function C(x){r="timeout"===x;v&&v();p&&p.abort()}function D(x,G,B,A,E,L){R(n)&&d.cancel(n);v=p=null;x(G,B,A,E,L)}k=k||a.url();if("jsonp"===xa(f))var y=c.createCallback(k),v=g(k,y,function(x,G){var B=200===x&&c.getResponse(y);D(l,x,B,"",G,"complete");c.removeCallback(y)});else{var p=b(f,k),r=!1;p.open(f,k,!0);I(m,function(x,G){R(x)&&p.setRequestHeader(G,x)});
...
if(w)try{p.responseType=w}catch(x){if("json"!==w)throw x;}p.send(U(h)?null:h)}if(0<q)var n=d(function(){C("timeout")},q);else q&&ca(q.then)&&q.then(function(){C(R(q.$$timeoutId)?"timeout":"abort")})}}function eh(){var a="{{",b="}}";this.startSymbol=function(d){return d?(a=d,this):a};this.endSymbol=function(d){return d?(b=d,this):b};this.$get=["$parse","$exceptionHandler","$sce",function(d,c,e){function g(w){return"\\\\\\"+w}function f(w){return w.replace(q,a).replace(t,b)}function k(w,H,F,C){var D=
w.$watch(function(y){D();return C(y)},H,F);return D}function h(w,H,F,C){function D(E){try{var L=E;E=F?e.getTrusted(F,L):e.valueOf(L);return C&&!R(E)?E:rd(E)}catch(Q){c(Ib.interr(w,Q))}}if(!w.length||-1===w.indexOf(a)){if(!H){H=f(w);var y=cb(H);y.exp=w;y.expressions=[];y.$$watchDelegate=k}return y}C=!!C;var v,p,r=0,n=[],x=[];y=w.length;for(var G=[],B=[];r<y;)if(-1!==(v=w.indexOf(a,r))&&-1!==(p=w.indexOf(b,v+l)))r!==v&&G.push(f(w.substring(r,v))),r=w.substring(v+l,p),n.push(r),x.push(d(r,D)),r=p+m,
B.push(G.length),G.push("");else{r!==y&&G.push(f(w.substring(r)));break}F&&1<G.length&&Ib.throwNoconcat(w);if(!H||n.length){var A=function(E){for(var L=0,Q=n.length;L<Q;L++){if(C&&U(E[L]))return;G[B[L]]=E[L]}return G.join("")};return Aa(function(E){var L=0,Q=n.length,S=Array(Q);try{for(;L<Q;L++)S[L]=x[L](E);return A(S)}catch(X){c(Ib.interr(w,X))}},{exp:w,expressions:n,$$watchDelegate:function(E,L){var Q;return E.$watchGroup(x,function(S,X){var ha=A(S);L.call(this,ha,S!==X?Q:ha,E);Q=ha})}})}}var l=
a.length,m=b.length,q=new RegExp(a.replace(/./g,g),"g"),t=new RegExp(b.replace(/./g,g),"g");h.startSymbol=function(){return a};h.endSymbol=function(){return b};return h}]}function fh(){this.$get=["$rootScope","$window","$q","$$q","$browser",function(a,b,d,c,e){function g(k,h,l,m){function q(){t?k.apply(null,w):k(C)}var t=4<arguments.length,w=t?hb.call(arguments,4):[],H=b.setInterval,F=b.clearInterval,C=0,D=R(m)&&!m,y=(D?c:d).defer(),v=y.promise;l=R(l)?l:0;v.$$intervalId=H(function(){D?e.defer(q):
...
"$window",function(c,e,g,f,k){function h(y,v,p){var r=F.url(),n=F.$$state;try{e.url(y,v,p),F.$$state=e.state()}catch(x){throw F.url(r),F.$$state=n,x;}}function l(y,v){c.$broadcast("$locationChangeSuccess",F.absUrl(),y,F.$$state,v)}var m=e.baseHref(),q=e.url();if(b.enabled){if(!m&&b.requireBase)throw mc("nobase");var t=q.substring(0,q.indexOf("/",q.indexOf("//")+2))+(m||"/");var w=g.history?Pd:Xe}else t=Gb(q),w=Qd;var H=t.substr(0,Gb(t).lastIndexOf("/")+1);var F=new w(t,H,"#"+a);F.$$parseLinkUrl(q,
...
F.absUrl()!==e.url()&&(c.$apply(),k.angular["ff-684208-preventDefault"]=!0))}}});nc(F.absUrl())!==nc(q)&&e.url(F.absUrl(),!0);var D=!0;e.onUrlChange(function(y,v){Od(y,H)?(c.$evalAsync(function(){var p=F.absUrl(),r=F.$$state;y=nc(y);F.$$parse(y);F.$$state=v;var n=c.$broadcast("$locationChangeStart",y,p,v,r).defaultPrevented;F.absUrl()===y&&(n?(F.$$parse(p),F.$$state=r,h(p,!1,r)):(D=!1,l(p,r)))}),c.$$phase||c.$digest()):k.location.href=y});c.$watch(function(){if(D||F.$$urlUpdatedByLocation){F.$$urlUpdatedByLocation=
!1;var y=nc(e.url()),v=nc(F.absUrl()),p=e.state(),r=F.$$replace,n=d(y,v,function(){return new w(t,H,"#"+a)}),x=F.$$html5&&g.history&&p!==F.$$state,G=y!==v||x;if(D||G)D=!1,c.$evalAsync(function(){var B=F.absUrl(),A=c.$broadcast("$locationChangeStart",B,y,F.$$state,p).defaultPrevented;F.absUrl()===B&&(A?(F.$$parse(y),F.$$state=p):((D||G&&n)&&h(B,r,p===F.$$state?null:F.$$state),l(y,p)))})}F.$$replace=!1});return F}]}function jh(){var a=!0,b=this;this.debugEnabled=function(d){return R(d)?(a=d,this):a};
this.$get=["$window",function(d){function c(g){var f=d.console||{},k=f[g]||f.log||ja;return function(){var h=[];I(arguments,function(l){var m=h.push;ld(l)&&(l.stack&&e?l=l.message&&-1===l.stack.indexOf(l.message)?"Error: "+l.message+"\n"+l.stack:l.stack:l.sourceURL&&(l=l.message+"\n"+l.sourceURL+":"+l.line));m.call(h,l)});return Function.prototype.apply.call(k,f,h)}}var e=qb||/\bEdge\//.test(d.navigator&&d.navigator.userAgent);return{log:c("log"),info:c("info"),warn:c("warn"),error:c("error"),debug:function(){var g=
...
function(b){return R(b)?(a=b,this):a}}function qh(){var a=!0;this.$get=["$browser","$exceptionHandler",function(b,d){return ff(function(c){b.defer(c)},d,a)}];this.errorOnUnhandledRejections=function(b){return R(b)?(a=b,this):a}}function ff(a,b,d){function c(){return new e}function e(){var r=this.promise=new g;this.resolve=function(n){h(r,n)};this.reject=function(n){m(r,n)};this.notify=function(n){t(r,n)}}function g(){this.$$state={status:0}}function f(){for(;!y&&v.length;){var r=v.shift();if(!r.pur){r.pur=
!0;var n=r.value;n="Possibly unhandled rejection: "+("function"===typeof n?n.toString().replace(/ \{[\s\S]*$/,""):U(n)?"undefined":"string"!==typeof n?eg(n,void 0):n);ld(r.value)?b(r.value,n):b(n)}}}function k(r){!d||r.pending||2!==r.status||r.pur||(0===y&&0===v.length&&a(f),v.push(r));!r.processScheduled&&r.pending&&(r.processScheduled=!0,++y,a(function(){var n=r.pending;r.processScheduled=!1;r.pending=void 0;try{for(var x=0,G=n.length;x<G;++x){r.pur=!0;var B=n[x][0];var A=n[x][r.status];try{ca(A)?
h(B,A(r.value)):1===r.status?h(B,r.value):m(B,r.value)}catch(E){m(B,E),E&&!0===E.$$passToExceptionHandler&&b(E)}}}finally{--y,d&&0===y&&a(f)}}))}function h(r,n){r.$$state.status||(n===r?q(r,D("qcycle",n)):l(r,n))}function l(r,n){function x(L){A||(A=!0,l(r,L))}function G(L){A||(A=!0,q(r,L))}function B(L){t(r,L)}var A=!1;try{if(fa(n)||ca(n))var E=n.then;ca(E)?(r.$$state.status=-1,E.call(n,x,G,B)):(r.$$state.value=n,r.$$state.status=1,k(r.$$state))}catch(L){G(L)}}function m(r,n){r.$$state.status||q(r,
n)}function q(r,n){r.$$state.value=n;r.$$state.status=2;k(r.$$state)}function t(r,n){var x=r.$$state.pending;0>=r.$$state.status&&x&&x.length&&a(function(){for(var G,B,A=0,E=x.length;A<E;A++){B=x[A][0];G=x[A][3];try{t(B,ca(G)?G(n):n)}catch(L){b(L)}}})}function w(r){var n=new g;m(n,r);return n}function H(r,n,x){var G=null;try{ca(x)&&(G=x())}catch(B){return w(B)}return G&&ca(G.then)?G.then(function(){return n(r)},w):n(r)}function F(r,n,x,G){var B=new g;h(B,r);return B.then(n,x,G)}function C(r){if(!ca(r))throw D("norslvr",
r);var n=new g;r(function(x){h(n,x)},function(x){m(n,x)});return n}var D=va("$q",TypeError),y=0,v=[];Aa(g.prototype,{then:function(r,n,x){if(U(r)&&U(n)&&U(x))return this;var G=new g;this.$$state.pending=this.$$state.pending||[];this.$$state.pending.push([G,r,n,x]);0<this.$$state.status&&k(this.$$state);return G},"catch":function(r){return this.then(null,r)},"finally":function(r,n){return this.then(function(x){return H(x,p,r)},function(x){return H(x,w,r)},n)}});var p=F;C.prototype=g.prototype;C.defer=
c;C.reject=w;C.when=F;C.resolve=p;C.all=function(r){var n=new g,x=0,G=oa(r)?[]:{};I(r,function(B,A){x++;F(B).then(function(E){G[A]=E;--x||h(n,G)},function(E){m(n,E)})});0===x&&h(n,G);return n};C.race=function(r){var n=c();I(r,function(x){F(x).then(n.resolve,n.reject)});return n.promise};return C}function rh(){this.$get=["$window","$timeout",function(a,b){var d=a.requestAnimationFrame||a.webkitRequestAnimationFrame,c=a.cancelAnimationFrame||a.webkitCancelAnimationFrame||a.webkitCancelRequestAnimationFrame,
...
return b};this.$get=["$exceptionHandler","$parse","$browser",function(g,f,k){function h(n){n.currentScope.$$destroyed=!0}function l(n){9===qb&&(n.$$childHead&&l(n.$$childHead),n.$$nextSibling&&l(n.$$nextSibling));n.$parent=n.$$nextSibling=n.$$prevSibling=n.$$childHead=n.$$childTail=n.$root=n.$$watchers=null}function m(){this.$id=++sc;this.$$phase=this.$parent=this.$$watchers=this.$$nextSibling=this.$$prevSibling=this.$$childHead=this.$$childTail=null;this.$root=this;this.$$suspended=this.$$destroyed=
!1;this.$$listeners={};this.$$listenerCount={};this.$$watchersCount=0;this.$$isolateBindings=null}function q(n){if(D.$$phase)throw d("inprog",D.$$phase);D.$$phase=n}function t(n,x){do n.$$watchersCount+=x;while(n=n.$parent)}function w(n,x,G){do n.$$listenerCount[G]-=x,0===n.$$listenerCount[G]&&delete n.$$listenerCount[G];while(n=n.$parent)}function H(){}function F(){for(;p.length;)try{p.shift()()}catch(n){g(n)}e=null}function C(){null===e&&(e=k.defer(function(){D.$apply(F)}))}m.prototype={constructor:m,
$new:function(n,x){x=x||this;if(n){var G=new m;G.$root=this.$root}else this.$$ChildScope||(this.$$ChildScope=a(this)),G=new this.$$ChildScope;G.$parent=x;G.$$prevSibling=x.$$childTail;x.$$childHead?(x.$$childTail.$$nextSibling=G,x.$$childTail=G):x.$$childHead=x.$$childTail=G;(n||x!==this)&&G.$on("$destroy",h);return G},$watch:function(n,x,G,B){var A=f(n);x=ca(x)?x:ja;if(A.$$watchDelegate)return A.$$watchDelegate(this,x,G,A,n);var E=this,L=E.$$watchers,Q={fn:x,last:H,get:A,exp:B||n,eq:!!G};c=null;
L||(L=E.$$watchers=[],L.$$digestWatchIndex=-1);L.unshift(Q);L.$$digestWatchIndex++;t(this,1);return function(){var S=cc(L,Q);0<=S&&(t(E,-1),S<L.$$digestWatchIndex&&L.$$digestWatchIndex--);c=null}},$watchGroup:function(n,x){function G(){Q=!1;S?(S=!1,x(A,A,L)):x(A,B,L)}var B=Array(n.length),A=Array(n.length),E=[],L=this,Q=!1,S=!0;if(!n.length){var X=!0;L.$evalAsync(function(){X&&x(A,A,L)});return function(){X=!1}}if(1===n.length)return this.$watch(n[0],function(ha,ka,ea){A[0]=ha;B[0]=ka;x(A,ha===ka?
A:B,ea)});I(n,function(ha,ka){ha=L.$watch(ha,function(ea,ma){A[ka]=ea;B[ka]=ma;Q||(Q=!0,L.$evalAsync(G))});E.push(ha)});return function(){for(;E.length;)E.shift()()}},$watchCollection:function(n,x){function G(ma){A=ma;var la;if(!U(A)){if(fa(A))if(ub(A))for(E!==X&&(E=X,ea=E.length=0,S++),ma=A.length,ea!==ma&&(S++,E.length=ea=ma),la=0;la<ma;la++){var ya=E[la];var ua=A[la];var mb=ya!==ya&&ua!==ua;mb||ya===ua||(S++,E[la]=ua)}else{E!==ha&&(E=ha={},ea=0,S++);ma=0;for(la in A)bb.call(A,la)&&(ma++,ua=A[la],
ya=E[la],la in E?(mb=ya!==ya&&ua!==ua,mb||ya===ua||(S++,E[la]=ua)):(ea++,E[la]=ua,S++));if(ea>ma)for(la in S++,E)bb.call(A,la)||(ea--,delete E[la])}else E!==A&&(E=A,S++);return S}}G.$stateful=!0;var B=this,A,E,L,Q=1<x.length,S=0;n=f(n,G);var X=[],ha={},ka=!0,ea=0;return this.$watch(n,function(){ka?(ka=!1,x(A,A,B)):x(A,L,B);if(Q)if(fa(A))if(ub(A)){L=Array(A.length);for(var ma=0;ma<A.length;ma++)L[ma]=A[ma]}else for(ma in L={},A)bb.call(A,ma)&&(L[ma]=A[ma]);else L=A})},$digest:function(){var n,x,G,
B,A=b,E=[];q("$digest");k.$$checkUrlChange();this===D&&null!==e&&(k.defer.cancel(e),F());c=null;do{var L=!1;var Q=this;for(B=0;B<y.length;B++){try{var S=y[B];var X=S.fn;X(S.scope,S.locals)}catch(ea){g(ea)}c=null}y.length=0;a:do{if(B=!Q.$$suspended&&Q.$$watchers)for(B.$$digestWatchIndex=B.length;B.$$digestWatchIndex--;)try{if(n=B[B.$$digestWatchIndex]){var ha=n.get;if((x=ha(Q))!==(G=n.last)&&!(n.eq?db(x,G):Ua(x)&&Ua(G))){if(L=!0,c=n,n.last=n.eq?Bb(x,null):x,X=n.fn,X(x,G===H?x:G,Q),5>A){var ka=4-A;
E[ka]||(E[ka]=[]);E[ka].push({msg:ca(n.exp)?"fn: "+(n.exp.name||n.exp.toString()):n.exp,newVal:x,oldVal:G})}}else if(n===c){L=!1;break a}}}catch(ea){g(ea)}if(!(B=!Q.$$suspended&&Q.$$watchersCount&&Q.$$childHead||Q!==this&&Q.$$nextSibling))for(;Q!==this&&!(B=Q.$$nextSibling);)Q=Q.$parent}while(Q=B);if((L||y.length)&&!A--)throw D.$$phase=null,d("infdig",b,E);}while(L||y.length);for(D.$$phase=null;r<v.length;)try{v[r++]()}catch(ea){g(ea)}v.length=r=0;k.$$checkUrlChange()},$suspend:function(){this.$$suspended=
!0},$isSuspended:function(){return this.$$suspended},$resume:function(){this.$$suspended=!1},$destroy:function(){if(!this.$$destroyed){var n=this.$parent;this.$broadcast("$destroy");this.$$destroyed=!0;this===D&&k.$$applicationDestroyed();t(this,-this.$$watchersCount);for(var x in this.$$listenerCount)w(this,this.$$listenerCount[x],x);n&&n.$$childHead===this&&(n.$$childHead=this.$$nextSibling);n&&n.$$childTail===this&&(n.$$childTail=this.$$prevSibling);this.$$prevSibling&&(this.$$prevSibling.$$nextSibling=
this.$$nextSibling);this.$$nextSibling&&(this.$$nextSibling.$$prevSibling=this.$$prevSibling);this.$destroy=this.$digest=this.$apply=this.$evalAsync=this.$applyAsync=ja;this.$on=this.$watch=this.$watchGroup=function(){return ja};this.$$listeners={};this.$$nextSibling=null;l(this)}},$eval:function(n,x){return f(n)(this,x)},$evalAsync:function(n,x){D.$$phase||y.length||k.defer(function(){y.length&&D.$digest()});y.push({scope:this,fn:f(n),locals:x})},$$postDigest:function(n){v.push(n)},$apply:function(n){try{q("$apply");
try{return this.$eval(n)}finally{D.$$phase=null}}catch(x){g(x)}finally{try{D.$digest()}catch(x){throw g(x),x;}}},$applyAsync:function(n){function x(){G.$eval(n)}var G=this;n&&p.push(x);n=f(n);C()},$on:function(n,x){var G=this.$$listeners[n];G||(this.$$listeners[n]=G=[]);G.push(x);var B=this;do B.$$listenerCount[n]||(B.$$listenerCount[n]=0),B.$$listenerCount[n]++;while(B=B.$parent);var A=this;return function(){var E=G.indexOf(x);-1!==E&&(delete G[E],w(A,1,n))}},$emit:function(n,x){var G=[],B=this,
A=!1,E={name:n,targetScope:B,stopPropagation:function(){A=!0},preventDefault:function(){E.defaultPrevented=!0},defaultPrevented:!1},L=dc([E],arguments,1),Q;do{var S=B.$$listeners[n]||G;E.currentScope=B;var X=0;for(Q=S.length;X<Q;X++)if(S[X])try{S[X].apply(null,L)}catch(ha){g(ha)}else S.splice(X,1),X--,Q--;if(A)break;B=B.$parent}while(B);E.currentScope=null;return E},$broadcast:function(n,x){var G=this,B=this,A={name:n,targetScope:this,preventDefault:function(){A.defaultPrevented=!0},defaultPrevented:!1};
if(!this.$$listenerCount[n])return A;for(var E=dc([A],arguments,1),L,Q;G=B;){A.currentScope=G;B=G.$$listeners[n]||[];L=0;for(Q=B.length;L<Q;L++)if(B[L])try{B[L].apply(null,E)}catch(S){g(S)}else B.splice(L,1),L--,Q--;if(!(B=G.$$listenerCount[n]&&G.$$childHead||G!==this&&G.$$nextSibling))for(;G!==this&&!(B=G.$$nextSibling);)G=G.$parent}A.currentScope=null;return A}};var D=new m,y=D.$$asyncQueue=[],v=D.$$postDigestQueue=[],p=D.$$applyAsyncQueue=[],r=0;return D}]}function th(){var a=/^\s*(https?|s?ftp|mailto|tel|file):/,
...
l&&(f=h<l?-1:1)}else f=k<h?-1:1;return f}return function(e,g,f,k){if(null==e)return e;if(!ub(e))throw va("orderBy")("notarray",e);oa(g)||(g=[g]);0===g.length&&(g=["+"]);var h=b(g),l=f?-1:1,m=ca(k)?k:c;e=Array.prototype.map.call(e,function(q,t){return{value:q,tieBreaker:{value:t,type:"number",index:t},predicateValues:h.map(function(w){var H=w.get(q);w=typeof H;if(null===H)w="string",H="null";else if("object"===w)a:{if(ca(H.valueOf)&&(H=H.valueOf(),d(H)))break a;kd(H)&&(H=H.toString(),d(H))}return{value:H,
type:w,index:t}})}});e.sort(function(q,t){for(var w=0,H=h.length;w<H;w++){var F=m(q.predicateValues[w],t.predicateValues[w]);if(F)return F*h[w].descending*l}return(m(q.tieBreaker,t.tieBreaker)||c(q.tieBreaker,t.tieBreaker))*l});return e=e.map(function(q){return q.value})}}function Vb(a){ca(a)&&(a={link:a});a.restrict=a.restrict||"AC";return cb(a)}function Yc(a,b,d,c,e){this.$$controls=[];this.$error={};this.$$success={};this.$pending=void 0;this.$name=e(b.name||b.ngForm||"")(d);this.$dirty=!1;this.$valid=
...
f;d*=f;c&&(a=Math.round(a));e&&(b=Math.round(b));g&&(d=Math.round(d))}return 0===(a-b)%d}function Bf(a,b,d,c,e){if(R(c)){a=a(c);if(!a.constant)throw rc("constexpr",d,c);return a(b)}return e}function Zd(a,b){function d(f,k){if(!f||!f.length)return[];if(!k||!k.length)return f;var h=[],l=0;a:for(;l<f.length;l++){for(var m=f[l],q=0;q<k.length;q++)if(m===k[q])continue a;h.push(m)}return h}function c(f){var k=f;oa(f)?k=f.map(c).join(" "):fa(f)&&(k=Object.keys(f).filter(function(h){return f[h]}).join(" "));
return k}function e(f){var k=f;if(oa(f))k=f.map(e);else if(fa(f)){var h=!1;k=Object.keys(f).filter(function(l){l=f[l];!h&&U(l)&&(h=!0);return l});h&&k.push(void 0)}return k}a="ngClass"+a;var g;return["$parse",function(f){return{restrict:"AC",link:function(k,h,l){function m(p,r){var n=[];I(p,function(x){if(0<r||D[x])D[x]=(D[x]||0)+r,D[x]===+(0<r)&&n.push(x)});return n.join(" ")}function q(p){if(p===b){var r=v;r=m(r&&r.split(" "),1);l.$addClass(r)}else r=v,r=m(r&&r.split(" "),-1),l.$removeClass(r);
y=p}function t(p){p=c(p);p!==v&&w(p)}function w(p){if(y===b){var r=v&&v.split(" "),n=p&&p.split(" "),x=d(r,n);r=d(n,r);x=m(x,-1);r=m(r,1);l.$addClass(r);l.$removeClass(x)}v=p}var H=l[a].trim(),F=":"===H.charAt(0)&&":"===H.charAt(1);H=f(H,F?e:c);var C=F?t:w,D=h.data("$classCounts"),y=!0,v;D||(D=Ea(),h.data("$classCounts",D));"ngClass"!==a&&(g||(g=f("$index",function(p){return p&1})),k.$watch(g,q));k.$watch(H,C,F)}}}]}function ad(a,b,d,c,e,g,f,k,h){this.$modelValue=this.$viewValue=Number.NaN;this.$$rawModelValue=
...
[];if(a.length){if(b)throw na(d)&&d||(d=a.name||tg(a)),Eb("strictdi",d);b=we(a);I(b[1].split(Xh),function(e){e.replace(Yh,function(g,f,k){c.push(k)})})}a.$inject=c}}else oa(a)?(b=a.length-1,vc(a[b],"fn"),c=a.slice(0,b)):vc(a,"fn",!0);return c};var Ef=va("$animate"),Zh=function(){this.$get=ja},$h=function(){var a=new Hc,b=[];this.$get=["$$AnimateRunner","$rootScope",function(d,c){function e(f,k,h){var l=!1;k&&(k=na(k)?k.split(" "):oa(k)?k:[],I(k,function(m){m&&(l=!0,f[m]=h)}));return l}function g(){I(b,
function(f){var k=a.get(f);if(k){var h=vg(f.attr("class")),l="",m="";I(k,function(q,t){q!==!!h[t]&&(q?l+=(l.length?" ":"")+t:m+=(m.length?" ":"")+t)});I(f,function(q){l&&Dc(q,l);m&&Cc(q,m)});a.delete(f)}});b.length=0}return{enabled:ja,on:ja,off:ja,pin:ja,push:function(f,k,h,l){l&&l();h=h||{};h.from&&f.css(h.from);h.to&&f.css(h.to);if(h.addClass||h.removeClass)if(k=h.addClass,l=h.removeClass,h=a.get(f)||{},k=e(h,k,!0),l=e(h,l,!1),k||l)a.set(f,h),b.push(f),1===b.length&&c.$$postDigest(g);f=new d;f.complete();
return f}}}]},ai=["$provide",function(a){var b=this,d=null,c=null;this.$$registeredAnimations=Object.create(null);this.register=function(e,g){if(e&&"."!==e.charAt(0))throw Ef("notcsel",e);var f=e+"-animation";b.$$registeredAnimations[e.substr(1)]=f;a.factory(f,g)};this.customFilter=function(e){1===arguments.length&&(c=ca(e)?e:null);return c};this.classNameFilter=function(e){if(1===arguments.length&&(d=e instanceof RegExp?e:null)&&RegExp("[(\\s|\\/)]ng-animate[(\\s|\\/)]").test(d.toString()))throw d=
null,Ef("nongcls","ng-animate");return d};this.$get=["$$animateQueue",function(e){function g(f,k,h){if(h){var l;a:{for(l=0;l<h.length;l++){var m=h[l];if(1===m.nodeType){l=m;break a}}l=void 0}!l||l.parentNode||l.previousElementSibling||(h=null)}h?h.after(f):k.prepend(f)}return{on:e.on,off:e.off,pin:e.pin,enabled:e.enabled,cancel:function(f){f.end&&f.end()},enter:function(f,k,h,l){k=k&&da(k);h=h&&da(h);k=k||h.parent();g(f,k,h);return e.push(f,"enter",Fb(l))},move:function(f,k,h,l){k=k&&da(k);h=h&&da(h);
k=k||h.parent();g(f,k,h);return e.push(f,"move",Fb(l))},leave:function(f,k){return e.push(f,"leave",Fb(k),function(){f.remove()})},addClass:function(f,k,h){h=Fb(h);h.addClass=jc(h.addclass,k);return e.push(f,"addClass",h)},removeClass:function(f,k,h){h=Fb(h);h.removeClass=jc(h.removeClass,k);return e.push(f,"removeClass",h)},setClass:function(f,k,h,l){l=Fb(l);l.addClass=jc(l.addClass,k);l.removeClass=jc(l.removeClass,h);return e.push(f,"setClass",l)},animate:function(f,k,h,l,m){m=Fb(m);m.from=m.from?
Aa(m.from,k):k;m.to=m.to?Aa(m.to,h):h;m.tempClasses=jc(m.tempClasses,l||"ng-inline-animate");return e.push(f,"animate",m)}}}]}],bi=function(){this.$get=["$$rAF",function(a){function b(c){d.push(c);1<d.length||a(function(){for(var e=0;e<d.length;e++)d[e]();d=[]})}var d=[];return function(){var c=!1;b(function(){c=!0});return function(e){c?e():b(e)}}}]},ci=function(){this.$get=["$q","$sniffer","$$animateAsyncRun","$$isDocumentHidden","$timeout",function(a,b,d,c,e){function g(f){this.setHost(f);var k=
d();this._doneCallbacks=[];this._tick=function(h){c()?e(h,0,!1):k(h)};this._state=0}g.chain=function(f,k){function h(){if(l===f.length)k(!0);else f[l](function(m){!1===m?k(!1):(l++,h())})}var l=0;h()};g.all=function(f,k){function h(q){m=m&&q;++l===f.length&&k(m)}var l=0,m=!0;I(f,function(q){q.done(h)})};g.prototype={setHost:function(f){this.host=f||{}},done:function(f){2===this._state?f():this._doneCallbacks.push(f)},progress:ja,getPromise:function(){if(!this.promise){var f=this;this.promise=a(function(k,
h){f.done(function(l){!1===l?h():k()})})}return this.promise},then:function(f,k){return this.getPromise().then(f,k)},"catch":function(f){return this.getPromise()["catch"](f)},"finally":function(f){return this.getPromise()["finally"](f)},pause:function(){this.host.pause&&this.host.pause()},resume:function(){this.host.resume&&this.host.resume()},end:function(){this.host.end&&this.host.end();this._resolve(!0)},cancel:function(){this.host.cancel&&this.host.cancel();this._resolve(!1)},complete:function(f){var k=
this;0===k._state&&(k._state=1,k._tick(function(){k._resolve(f)}))},_resolve:function(f){2!==this._state&&(I(this._doneCallbacks,function(k){k(f)}),this._doneCallbacks.length=0,this._state=2)}};return g}]},di=function(){this.$get=["$$rAF","$q","$$AnimateRunner",function(a,b,d){return function(c,e){function g(){a(function(){f.addClass&&(c.addClass(f.addClass),f.addClass=null);f.removeClass&&(c.removeClass(f.removeClass),f.removeClass=null);f.to&&(c.css(f.to),f.to=null);k||h.complete();k=!0});return h}
var f=e||{};f.$$prepared||(f=Bb(f));f.cleanupStyles&&(f.from=f.to=null);f.from&&(c.css(f.from),f.from=null);var k,h=new d;return{start:g,end:g}}}]},Ka=va("$compile"),Jd=new function(){};xe.$inject=["$provide","$$sanitizeUriProvider"];Rc.prototype.isFirstChange=function(){return this.previousValue===Jd};var Be=/^((?:x|data)[:\-_])/i,Pg=/[:\-_]+(.)/g,Qe=va("$controller"),Pe=/^(\S+)(\s+as\s+([\w$]+))?$/,ei=function(){this.$get=["$document",function(a){return function(b){b?!b.nodeType&&b instanceof da&&
(b=b[0]):b=a[0].body;return b.offsetWidth+1}}]},Re="application/json",Md={"Content-Type":Re+";charset=utf-8"},Yg=/^\[|^\{(?!\{)/,Zg={"[":/]$/,"{":/}$/},Xg=/^\)]\}',?\n/,Sc=va("$http"),Ib=Va.$interpolateMinErr=va("$interpolate");Ib.throwNoconcat=function(a){throw Ib("noconcat",a);};Ib.interr=function(a,b){return Ib("interr",a,b.toString())};var fi=function(){this.$get=function(){function a(c){var e=function(g){e.data=g;e.called=!0};e.id=c;return e}var b=Va.callbacks,d={};return{createCallback:function(c){c=
"_"+(b.$$counter++).toString(36);var e="angular.callbacks."+c,g=a(c);d[e]=b[c]=g;return e},wasCalled:function(c){return d[c].called},getResponse:function(c){return d[c].data},removeCallback:function(c){delete b[d[c].id];delete d[c]}}}},gi=/^([^?#]*)(\?([^#]*))?(#(.*))?$/,gh={http:80,https:443,ftp:21},mc=va("$location"),hh=/^\s*[\\/]{2,}/,hi={$$absUrl:"",$$html5:!1,$$replace:!1,absUrl:Uc("$$absUrl"),url:function(a){if(U(a))return this.$$url;var b=gi.exec(a);(b[1]||""===a)&&this.path(decodeURIComponent(b[1]));
(b[2]||b[1]||""===a)&&this.search(b[3]||"");this.hash(b[5]||"");return this},protocol:Uc("$$protocol"),host:Uc("$$host"),port:Uc("$$port"),path:Ye("$$path",function(a){a=null!==a?a.toString():"";return"/"===a.charAt(0)?a:"/"+a}),search:function(a,b){switch(arguments.length){case 0:return this.$$search;case 1:if(na(a)||Pa(a))a=a.toString(),this.$$search=pd(a);else if(fa(a))a=Bb(a,{}),I(a,function(d,c){null==d&&delete a[c]}),this.$$search=a;else throw mc("isrcharg");break;default:U(b)||null===b?delete this.$$search[a]:
...
l),f.assign(b,k),d&&(d.computed=!0,d.name=l)):(e&&1!==e&&f.if_(f.isNull(f.nonComputedMember(h,a.property.name)),f.lazyAssign(f.nonComputedMember(h,a.property.name),"{}")),k=f.nonComputedMember(h,a.property.name),f.assign(b,k),d&&(d.computed=!1,d.name=a.property.name))},function(){f.assign(b,"undefined")});c(b)},!!e);break;case P.CallExpression:b=b||this.nextId();if(a.filter){var l=f.filter(a.callee.name);var m=[];I(a.arguments,function(t){var w=f.nextId();f.recurse(t,w);m.push(w)});k=l+"("+m.join(",")+
")";f.assign(b,k);c(b)}else l=f.nextId(),h={},m=[],f.recurse(a.callee,l,h,function(){f.if_(f.notNull(l),function(){I(a.arguments,function(t){f.recurse(t,a.constant?void 0:f.nextId(),void 0,function(w){m.push(w)})});k=h.name?f.member(h.context,h.name,h.computed)+"("+m.join(",")+")":l+"("+m.join(",")+")";f.assign(b,k)},function(){f.assign(b,"undefined")});c(b)});break;case P.AssignmentExpression:l=this.nextId();h={};this.recurse(a.left,void 0,h,function(){f.if_(f.notNull(h.context),function(){f.recurse(a.right,
l);k=f.member(h.context,h.name,h.computed)+a.operator+l;f.assign(b,k);c(b||k)})},1);break;case P.ArrayExpression:m=[];I(a.elements,function(t){f.recurse(t,a.constant?void 0:f.nextId(),void 0,function(w){m.push(w)})});k="["+m.join(",")+"]";this.assign(b,k);c(b||k);break;case P.ObjectExpression:m=[];var q=!1;I(a.properties,function(t){t.computed&&(q=!0)});q?(b=b||this.nextId(),this.assign(b,"{}"),I(a.properties,function(t){t.computed?(h=f.nextId(),f.recurse(t.key,h)):h=t.key.type===P.Identifier?t.key.name:
""+t.key.value;l=f.nextId();f.recurse(t.value,l);f.assign(f.member(b,h,t.computed),l)})):(I(a.properties,function(t){f.recurse(t.value,a.constant?void 0:f.nextId(),void 0,function(w){m.push(f.escape(t.key.type===P.Identifier?t.key.name:""+t.key.value)+":"+w)})}),k="{"+m.join(",")+"}",this.assign(b,k));c(b||k);break;case P.ThisExpression:this.assign(b,"s");c(b||"s");break;case P.LocalsExpression:this.assign(b,"l");c(b||"l");break;case P.NGValueParameter:this.assign(b,"v"),c(b||"v")}},getHasOwnProperty:function(a,
...
b,d){return function(c,e,g,f){c=e&&a in e?e:c;d&&1!==d&&c&&null==c[a]&&(c[a]={});e=c?c[a]:void 0;return b?{context:c,name:a,value:e}:e}},computedMember:function(a,b,d,c){return function(e,g,f,k){var h=a(e,g,f,k);if(null!=h){var l=b(e,g,f,k);l+="";c&&1!==c&&h&&!h[l]&&(h[l]={});var m=h[l]}return d?{context:h,name:l,value:m}:m}},nonComputedMember:function(a,b,d,c){return function(e,g,f,k){e=a(e,g,f,k);c&&1!==c&&e&&null==e[b]&&(e[b]={});g=null!=e?e[b]:void 0;return d?{context:e,name:b,value:g}:g}},inputs:function(a,
...
a&&g.ngForm?"ngForm":!1;return{pre:function(k,h,l,m){var q=m[0];if(!("action"in l)){var t=function(H){k.$apply(function(){q.$commitViewValue();q.$setSubmitted()});H.preventDefault()};h[0].addEventListener("submit",t);h.on("$destroy",function(){b(function(){h[0].removeEventListener("submit",t)},0,!1)})}(m[1]||q.$$parentForm).$addControl(q);var w=f?c(q.$name):ja;f&&(w(k,q),l.$observe(f,function(H){q.$name!==H&&(w(k,void 0),q.$$parentForm.$$renameControl(q,H),w=c(q.$name),w(k,q))}));h.on("$destroy",
...
b,d,c,e,g){function f(C,D){b.attr(C,d[C]);d.$observe(C,D)}function k(C){q=Xb(C);Ua(c.$modelValue)||(m?(C=b.val(),q>C&&(C=q,b.val(C)),c.$setViewValue(C)):c.$validate())}function h(C){t=Xb(C);Ua(c.$modelValue)||(m?(C=b.val(),t<C&&(b.val(t),C=t<q?q:t),c.$setViewValue(C)):c.$validate())}function l(C){w=Xb(C);Ua(c.$modelValue)||(m&&c.$viewValue!==b.val()?c.$setViewValue(b.val()):c.$validate())}Xd(a,b,d,c);zf(c);Wb(a,b,d,c,e,g);var m=c.$$hasNativeValidators&&"range"===b[0].type,q=m?0:void 0,t=m?100:void 0,
w=m?1:void 0,H=b[0].validity;a=R(d.min);e=R(d.max);g=R(d.step);var F=c.$render;c.$render=m&&R(H.rangeUnderflow)&&R(H.rangeOverflow)?function(){F();c.$setViewValue(b.val())}:F;a&&(c.$validators.min=m?function(){return!0}:function(C,D){return c.$isEmpty(D)||U(q)||D>=q},f("min",k));e&&(c.$validators.max=m?function(){return!0}:function(C,D){return c.$isEmpty(D)||U(t)||D<=t},f("max",h));g&&(c.$validators.step=m?function(){return!H.stepMismatch}:function(C,D){return c.$isEmpty(D)||U(w)||Af(D,q||0,w)},f("step",
l))},checkbox:function(a,b,d,c,e,g,f,k){var h=Bf(k,a,"ngTrueValue",d.ngTrueValue,!0),l=Bf(k,a,"ngFalseValue",d.ngFalseValue,!1);b.on("click",function(m){c.$setViewValue(b[0].checked,m&&m.type)});c.$render=function(){b[0].checked=c.$viewValue};c.$isEmpty=function(m){return!1===m};c.$formatters.push(function(m){return db(m,h)});c.$parsers.push(function(m){return m?h:l})},hidden:ja,button:ja,submit:ja,reset:ja,file:ja},Lf=["$browser","$sniffer","$filter","$parse",function(a,b,d,c){return{restrict:"E",
...
function(){var m=g(k);h.html(a.getTrustedHtml(m)||"")})}}}}],ui=cb({restrict:"A",require:"ngModel",link:function(a,b,d,c){c.$viewChangeListeners.push(function(){a.$eval(d.ngChange)})}}),vi=Zd("",!0),wi=Zd("Odd",0),xi=Zd("Even",1),yi=Vb({compile:function(a,b){b.$set("ngCloak",void 0);a.removeClass("ng-cloak")}}),zi=[function(){return{restrict:"A",scope:!0,controller:"@",priority:500}}],Mf={},Ai={blur:!0,focus:!0};I("click dblclick mousedown mouseup mouseover mouseout mousemove mouseenter mouseleave keydown keyup keypress submit focus blur copy cut paste".split(" "),
function(a){var b=lb("ng-"+a);Mf[b]=["$parse","$rootScope",function(d,c){return{restrict:"A",compile:function(e,g){var f=d(g[b]);return function(k,h){h.on(a,function(l){var m=function(){f(k,{$event:l})};Ai[a]&&c.$$phase?k.$evalAsync(m):k.$apply(m)})}}}}]});var Bi=["$animate","$compile",function(a,b){return{multiElement:!0,transclude:"element",priority:600,terminal:!0,restrict:"A",$$tlb:!0,link:function(d,c,e,g,f){var k,h,l;d.$watch(e.ngIf,function(m){m?h||f(function(q,t){h=t;q[q.length++]=b.$$createComment("end ngIf",
e.ngIf);k={clone:q};a.enter(q,c.parent(),c)}):(l&&(l.remove(),l=null),h&&(h.$destroy(),h=null),k&&(l=wc(k.clone),a.leave(l).done(function(q){!1!==q&&(l=null)}),k=null))})}}}],Ci=["$templateRequest","$anchorScroll","$animate",function(a,b,d){return{restrict:"ECA",priority:400,terminal:!0,transclude:"element",controller:Va.noop,compile:function(c,e){var g=e.ngInclude||e.src,f=e.onload||"",k=e.autoscroll;return function(h,l,m,q,t){var w=0,H,F,C,D=function(){F&&(F.remove(),F=null);H&&(H.$destroy(),H=
null);C&&(d.leave(C).done(function(y){!1!==y&&(F=null)}),F=C,C=null)};h.$watch(g,function(y){var v=function(r){!1===r||!R(k)||k&&!h.$eval(k)||b()},p=++w;y?(a(y,!0).then(function(r){if(!h.$$destroyed&&p===w){var n=h.$new();q.template=r;r=t(n,function(x){D();d.enter(x,null,l).done(v)});H=n;C=r;H.$emit("$includeContentLoaded",y);h.$eval(f)}},function(){h.$$destroyed||p!==w||(D(),h.$emit("$includeContentError",y))}),h.$emit("$includeContentRequested",y)):(D(),q.template=null)})}}}}],Di=["$compile",function(a){return{restrict:"ECA",
...
function(h,l){c(l,null)})),c(k,f.$$parserValid),f.$$parserValid;return!0})()?function(){var k=!0;I(f.$validators,function(h,l){h=!!h(a,b);k=k&&h;c(l,h)});return k?!0:(I(f.$asyncValidators,function(h,l){c(l,null)}),!1)}()?function(){var k=[],h=!0;I(f.$asyncValidators,function(l,m){l=l(a,b);if(!l||!ca(l.then))throw rc("nopromise",l);c(m,void 0);k.push(l.then(function(){c(m,!0)},function(){h=!1;c(m,!1)}))});k.length?f.$$q.all(k).then(function(){e(h)},ja):e(!0)}():e(!1):e(!1)},$commitViewValue:function(){var a=
...
/^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?(?:\s+disable\s+when\s+([\s\S]+?))?\s+for\s+(?:([$\w][$\w]*)|(?:\(\s*([$\w][$\w]*)\s*,\s*([$\w][$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/,Mi=["$compile","$document","$parse",function(a,b,d){function c(f,k,h){function l(B,A,E,L,Q){this.selectValue=B;this.viewValue=A;this.label=E;this.group=L;this.disabled=Q}function m(B){if(!w&&ub(B))var A=B;else{A=[];for(var E in B)B.hasOwnProperty(E)&&"$"!==E.charAt(0)&&A.push(E)}return A}
var q=f.match(Li);if(!q)throw Ki("iexp",f,jb(k));var t=q[5]||q[7],w=q[6];f=/ as /.test(q[0])&&q[1];var H=q[9];k=d(q[2]?q[1]:t);var F=f&&d(f)||k,C=H&&d(H),D=H?function(B,A){return C(h,A)}:function(B){return Pb(B)},y=function(B,A){return D(B,G(B,A))},v=d(q[2]||q[1]),p=d(q[3]||""),r=d(q[4]||""),n=d(q[8]),x={},G=w?function(B,A){x[w]=A;x[t]=B;return x}:function(B){x[t]=B;return x};return{trackBy:H,getTrackByValue:y,getWatchables:d(n,function(B){var A=[];B=B||[];for(var E=m(B),L=E.length,Q=0;Q<L;Q++){var S=
B===E?Q:E[Q],X=B[S];S=G(X,S);X=D(X,S);A.push(X);if(q[2]||q[1])X=v(h,S),A.push(X);q[4]&&(S=r(h,S),A.push(S))}return A}),getOptions:function(){for(var B=[],A={},E=n(h)||[],L=m(E),Q=L.length,S=0;S<Q;S++){var X=E===L?S:L[S],ha=G(E[X],X),ka=F(h,ha);X=D(ka,ha);var ea=v(h,ha),ma=p(h,ha);ha=r(h,ha);ka=new l(X,ka,ea,ma,ha);B.push(ka);A[X]=ka}return{items:B,selectValueMap:A,getOptionFromViewValue:function(la){return A[y(la)]},getViewValueFromOption:function(la){return H?Bb(la.viewValue):la.viewValue}}}}}var e=
ia.document.createElement("option"),g=ia.document.createElement("optgroup");return{restrict:"A",terminal:!0,require:["select","ngModel"],link:{pre:function(f,k,h,l){l[0].registerOption=ja},post:function(f,k,h,l){function m(p){var r=(p=D.getOptionFromViewValue(p))&&p.element;r&&!r.selected&&(r.selected=!0);return p}function q(p,r){p.element=r;r.disabled=p.disabled;p.label!==r.label&&(r.label=p.label,r.textContent=p.label);r.value=p.selectValue}var t=l[0],w=l[1],H=h.multiple;l=0;for(var F=k.children(),
C=F.length;l<C;l++)if(""===F[l].value){t.hasEmptyOption=!0;t.emptyOption=F.eq(l);break}k.empty();l=!!t.emptyOption;da(e.cloneNode(!1)).val("?");var D,y=c(h.ngOptions,k,f),v=b[0].createDocumentFragment();t.generateUnknownOptionValue=function(p){return"?"};H?(t.writeValue=function(p){if(D){var r=p&&p.map(m)||[];D.items.forEach(function(n){n.element.selected&&-1===Array.prototype.indexOf.call(r,n)&&(n.element.selected=!1)})}},t.readValue=function(){var p=k.val()||[],r=[];I(p,function(n){(n=D.selectValueMap[n])&&
!n.disabled&&r.push(D.getViewValueFromOption(n))});return r},y.trackBy&&f.$watchCollection(function(){if(oa(w.$viewValue))return w.$viewValue.map(function(p){return y.getTrackByValue(p)})},function(){w.$render()})):(t.writeValue=function(p){if(D){var r=k[0].options[k[0].selectedIndex],n=D.getOptionFromViewValue(p);r&&r.removeAttribute("selected");n?(k[0].value!==n.selectValue&&(t.removeUnknownOption(),k[0].value=n.selectValue,n.element.selected=!0),n.element.setAttribute("selected","selected")):t.selectUnknownOrEmptyOption(p)}},
...
function(){var n=t.$isEmptyOptionSelected();t.hasEmptyOption=!1;t.emptyOption=void 0;n&&w.$render()}))}):t.emptyOption.removeClass("ng-scope"));f.$watchCollection(y.getWatchables,function(){var p=D&&t.readValue();if(D)for(var r=D.items.length-1;0<=r;r--){var n=D.items[r];R(n.group)?Fc(n.element.parentNode):Fc(n.element)}D=y.getOptions();var x={};D.items.forEach(function(G){if(R(G.group)){var B=x[G.group];B||(B=g.cloneNode(!1),v.appendChild(B),B.label=null===G.group?"null":G.group,x[G.group]=B);var A=
e.cloneNode(!1);B.appendChild(A);q(G,A)}else B=e.cloneNode(!1),v.appendChild(B),q(G,B)});k[0].appendChild(v);w.$render();w.$isEmpty(p)||(r=t.readValue(),(y.trackBy||H?db(p,r):p===r)||(w.$setViewValue(r),w.$render()))})}}}}],Ni=["$locale","$interpolate","$log",function(a,b,d){var c=/{}/g,e=/^when(Minus)?(.+)$/;return{link:function(g,f,k){function h(v){f.text(v||"")}var l=k.count,m=k.$attr.when&&f.attr(k.$attr.when),q=k.offset||0,t=g.$eval(m)||{},w={},H=b.startSymbol(),F=b.endSymbol(),C=H+l+"-"+q+F,
D=Va.noop,y;I(k,function(v,p){if(v=e.exec(p))v=(v[1]?"-":"")+xa(v[2]),t[v]=f.attr(k.$attr[p])});I(t,function(v,p){w[p]=b(v.replace(c,C))});g.$watch(l,function(v){var p=parseFloat(v),r=Ua(p);r||p in t||(p=a.pluralCat(p-q));p===y||r&&Ua(y)||(D(),r=w[p],U(r)?(null!=v&&d.debug("ngPluralize: no rule defined for '"+p+"' in "+m),D=ja,h()):D=g.$watch(r,h),y=p)})}}}],Oi=["$parse","$animate","$compile",function(a,b,d){var c=va("ngRepeat"),e=function(g,f,k,h,l,m,q){g[k]=h;l&&(g[l]=m);g.$index=f;g.$first=0===
f;g.$last=f===q-1;g.$middle=!(g.$first||g.$last);g.$odd=!(g.$even=0===(f&1))};return{restrict:"A",multiElement:!0,transclude:"element",priority:1E3,terminal:!0,$$tlb:!0,compile:function(g,f){var k=f.ngRepeat,h=d.$$createComment("end ngRepeat",k);g=k.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+track\s+by\s+([\s\S]+?))?\s*$/);if(!g)throw c("iexp",k);f=g[1];var l=g[2],m=g[3],q=g[4];g=f.match(/^(?:(\s*[$\w]+)|\(\s*([$\w]+)\s*,\s*([$\w]+)\s*\))$/);if(!g)throw c("iidexp",f);var t=
g[3]||g[1],w=g[2];if(m&&(!/^[$a-zA-Z_][$a-zA-Z0-9_]*$/.test(m)||/^(null|undefined|this|\$index|\$first|\$middle|\$last|\$even|\$odd|\$parent|\$root|\$id)$/.test(m)))throw c("badident",m);var H,F={$id:Pb};if(q)var C=a(q);else{var D=function(v,p){return Pb(p)};var y=function(v){return v}}return function(v,p,r,n,x){C&&(H=function(B,A,E){w&&(F[w]=B);F[t]=A;F.$index=E;return C(v,F)});var G=Ea();v.$watchCollection(l,function(B){var A,E=p[0],L=Ea();m&&(v[m]=B);if(ub(B)){var Q=B;var S=H||D}else for(ha in S=
...
[],k=[],h=[],l=[],m=function(q,t){return function(w){!1!==w&&q.splice(t,1)}};d.$watch(e.ngSwitch||e.on,function(q){for(var t,w;h.length;)a.cancel(h.pop());t=0;for(w=l.length;t<w;++t){var H=wc(k[t].clone);l[t].$destroy();(h[t]=a.leave(H)).done(m(h,t))}k.length=0;l.length=0;(f=g.cases["!"+q]||g.cases["?"])&&I(f,function(F){F.transclude(function(C,D){l.push(D);D=F.element;C[C.length++]=b.$$createComment("end ngSwitchWhen");k.push({clone:C});a.enter(C,D.parent(),D)})})})}}}],Ti=Vb({transclude:"element",
...
compile:function(b){var d=a(b.contents());b.empty();return function(c,e,g,f,k){function h(){d(c,function(l){e.append(l)})}if(!k)throw Vi("orphan",jb(e));g.ngTransclude===g.$attr.ngTransclude&&(g.ngTransclude="");g=g.ngTransclude||g.ngTranscludeSlot;k(function(l,m){var q;if(q=l.length)a:{q=0;for(var t=l.length;q<t;q++){var w=l[q];if(w.nodeType!==wb||w.nodeValue.trim()){q=!0;break a}}q=void 0}q?e.append(l):(h(),m.$destroy())},null,g);g&&!k.isSlotFilled(g)&&h()}}}}],Xi=["$templateCache",function(a){return{restrict:"E",
...
a[0].options[a[0].selectedIndex]===e.emptyOption[0]};e.selectUnknownOrEmptyOption=function(h){null==h&&e.emptyOption?(e.removeUnknownOption(),e.selectEmptyOption()):e.unknownOption.parent().length?e.updateUnknownOption(h):e.renderUnknownOption(h)};var f=!1,k=!1;e.registerOption=function(h,l,m,q,t){if(m.$attr.ngValue){var w,H=NaN;m.$observe("value",function(F){var C=l.prop("selected");if(R(H)){e.removeOption(w);delete e.selectValueMap[H];var D=!0}H=Pb(F);w=F;e.selectValueMap[H]=F;e.addOption(F,l);
l.attr("value",H);D&&C&&c()})}else q?m.$observe("value",function(F){e.readValue();var C=l.prop("selected");if(R(w)){e.removeOption(w);var D=!0}w=F;e.addOption(F,l);D&&C&&c()}):t?h.$watch(t,function(F,C){m.$set("value",F);var D=l.prop("selected");C!==F&&e.removeOption(C);e.addOption(F,l);C&&D&&c()}):e.addOption(m.value,l);m.$observe("disabled",function(F){if("true"===F||F&&l.prop("selected"))e.multiple?c(!0):(e.ngModelCtrl.$setViewValue(null),e.ngModelCtrl.$render())});l.on("$destroy",function(){var F=
e.readValue(),C=m.value;e.removeOption(C);d();(e.multiple&&F&&-1!==F.indexOf(C)||F===C)&&c(!0)})}}],$i=function(){return{restrict:"E",require:["select","?ngModel"],controller:Zi,priority:1,link:{pre:function(a,b,d,c){var e=c[0],g=c[1];if(g){if(e.ngModelCtrl=g,b.on("change",function(){e.removeUnknownOption();a.$apply(function(){g.$setViewValue(e.readValue())})}),d.multiple){e.multiple=!0;e.readValue=function(){var h=[];I(b.find("option"),function(l){l.selected&&!l.disabled&&(l=l.value,h.push(l in e.selectValueMap?
e.selectValueMap[l]:l))});return h};e.writeValue=function(h){I(b.find("option"),function(l){var m=!!h&&(-1!==Array.prototype.indexOf.call(h,l.value)||-1!==Array.prototype.indexOf.call(h,e.selectValueMap[l.value]));m!==l.selected&&Lb(da(l),m)})};var f,k=NaN;a.$watch(function(){k!==g.$viewValue||db(f,g.$viewValue)||(f=kb(g.$viewValue),g.$render());k=g.$viewValue});g.$isEmpty=function(h){return!h||0===h.length}}}else e.registerOption=ja},post:function(a,b,d,c){var e=c[1];if(e){var g=c[0];e.$render=function(){g.writeValue(e.$viewValue)}}}}}},
